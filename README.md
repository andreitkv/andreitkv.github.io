# Andrei Tverdiukov — Portfolio

Local portfolio draft for 3D character animation, animation tools and practical
macOS automation.
...
Nothing in this folder is published automatically. Open `index.html` locally or
run a simple local web server to review the draft.
